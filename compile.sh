...
env CGO_ENABLED="1" CC="/usr/bin/i686-w64-mingw32-gcc" GOOS="windows" GOARCH="386" CGO_LDFLAGS="-lmingw32 -lSDL2 -lSDL2_mixer" CGO_CFLAGS="-D_REENTRANT" go build -o $WIN/box.exe main.go
cd $WIN/..
